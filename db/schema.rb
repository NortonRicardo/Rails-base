...
ActiveRecord::Schema.define(version: 2020_09_12_001510) do
  ...
  create_table "register_animal_types", force: :cascade do |t|
  ...
  create_table "users", force: :cascade do |t|
    t.string "user_name", comment: "Nome de Usuario"
